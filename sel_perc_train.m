function model = sel_perc_train(X,Y,model)
% SEL_PERC_TRAIN Kernel Selective Perceptron algorithm 
%
%    MODEL = SEL_PERC_TRAIN(X,Y,MODEL) trains an classifier according to
%    the Selective Perceptron algorithm.
%
